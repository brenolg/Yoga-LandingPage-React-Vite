  ...
  return (
    <EventFlipCard>
      <ReactCardFlip isFlipped={isFlipped} flipSpeedBackToFront={1.3} flipSpeedFrontToBack={1.3}>
        ...
        <button onClick={() => setIsFlipped(!isFlipped)} type="button" className="event-front-card third" aria-label="Yoga no Parque">
      ...
      <p className="sub-card-text H4">Vinyasa Yoga</p>
    </EventFlipCard>
  );
}
